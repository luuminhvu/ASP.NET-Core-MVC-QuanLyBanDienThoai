...
namespace QuanLyBanDienThoai.Areas.Admin.Controllers
{
    ...
    public class AdminCustomersController : Controller
    {
        ...
        public AdminCustomersController(QlbanDienThoaiContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Index(int? page)
        {
            ...
            var pageSize = 20;
            var lstCustomers = _context.Customers.AsNoTracking().Include(x => x.Location).OrderByDescending(x => x.CreateDate);
            PagedList<Customer> models = new PagedList<Customer>(lstCustomers, pageNumber, pageSize);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'QlbanDienThoaiContext.Customers'  is null.");
            }
            var customer = await _context.Customers.FindAsync(id);
            if (customer != null)
            {
